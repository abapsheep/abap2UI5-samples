...
CLASS z2ui5_cl_demo_app_305 IMPLEMENTATION.
  ...
  METHOD set_view.
    ...
    DATA(page) = view->shell(
                      ...
                      title          = 'abap2UI5 - Tables and row colors'
    ...
    page->_generic(
           ...
           `tr:has([data-color="red"]){ `
        && `    background-color: red;`
        && `}`
        && ``
        && `tr:has([data-color="green"]){`
        && `    background-color: green;`
        && `}`
        && ``
        && `tr:has([data-color="blue"]){`
        && `    background-color: blue;`
        && `}`
        && ``
        && `tr:has([data-color="orange"]){`
        && `    background-color: orange;`
        && `}`
        && ``
        && `tr:has([data-color="grey"]){`
        && `    background-color: grey;`
        && `}`
        && ``
        && `tr:has([data-color="yellow"]){`
